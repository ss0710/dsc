                    ...
                    <ReactBootStrap.Row>
                        <ReactBootStrap.Col lg={6} md={12} sm={12}>
                            <div className="startup-card">
                                ...
                                <img src={StartupBck} alt="startup" className="startup-bck-img"/>
                                <img src={Hihome} alt="startup" className="hihome-img"/>
                                <h2>HIHOME</h2>
                        ...
                        <div className="startup-card">
                                <div className="startup-div">
                                <img src={StartupBck} alt="" className="startup-bck-img"/>
                                <img src={Ambulon} alt="" className="hihome-img"/>
                                <h2>AMBULON</h2>
                        ...
                        <div className="startup-card">
                                <div className="startup-div">
                                <img src={StartupBck} alt="startup" className="startup-bck-img"/>
                                <img src={ANVESHANA} alt="startup" className="hihome-img"/>
